      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          $.each(data, function (key, value) {
            $('#city_origin').append("<option value=\"".concat(key, "\"> ").concat(value, " </option>"));
          });
        }
      });
    } else {
    ...
    if (provinceId) {
      $.ajax({
        ...
        success: function success(data) {
          ...
          $.each(data, function (key, value) {
            $('#city_destination').append("<option value=\"".concat(key, "\"> ").concat(value, " </option>"));
          });
        }
      });
    } else {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkRajaOngkir"] = self["webpackChunkRajaOngkir"] || [];
